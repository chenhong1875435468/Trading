...
input bool                 InpUseCandleTrendFilter     = false;
...
input int                  InpCandleMinMomentumCloses  = 1;
...
input double               InpLongTrendRewardRisk      = 0.00;
...
input double               InpBreakevenTriggerR        = 0.70;
...
input bool                 InpAvoidWeekendEntries      = true;
